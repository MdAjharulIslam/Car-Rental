  ...
  return (
    ...
    >
      <div className="text-white">
        <h2 className="text-3xl font-medium">Do You Own a Luxery Car?</h2>

        <p className="mt-2">
          Monetize your vehical effortlessly by listing it on Car Rental
        </p>

        <p className="max-w-130">
          we know care of insurence, driver verification and secure payments -
