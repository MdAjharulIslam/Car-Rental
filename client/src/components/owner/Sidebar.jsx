          ...
          <img className="h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto"
            src={
              image
                ...
                : user?.image ||
                  "https://images.unsplash.com/photo-1750432899498-2b85cd437228?q=80&w=1972&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            }
            alt=""
          />
          <input
